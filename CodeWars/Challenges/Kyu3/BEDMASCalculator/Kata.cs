...
/// <summary>
/// For this <see href="https://www.codewars.com/kata/56a14b6b56e5917073000022">Kata</see>
/// Submission found <see href="https://www.codewars.com/kata/reviews/56a14b753988ace0d900000a/groups/6826587854f5490bdbc32ce1">here</see>
/// </summary>
public static class Kata
{
    ...
    private static LinkedList<object> Scanner(string expression)
    {
    ...
    private static LinkedList<object> Shunting(LinkedList<object> tokens)
    {
    ...
    private static double EvaluatePolishOrder(LinkedList<object> rpn)
    {
    ...
    //Utilities
    private static bool TryGetLiteral(string expression, int start, out double value, out int length)
    {
        //precheck
