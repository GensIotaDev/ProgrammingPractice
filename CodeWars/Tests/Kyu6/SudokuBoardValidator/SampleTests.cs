using Challenges.Kyu6.SudokuBoardValidator;

namespace Tests.Kyu6.SudokuBoardValidator;
...
{
    public static IEnumerable<object[]> FixedBoardData = new[]
    {
        new object[]
        {
            new []{ // A board full of fives
        ...
        new object[]{ // a valid board, but with 0 instead of 9
            new []{
                ...
                new[]{2,0,3,8,5,6,4,7,1}}, false
        },
        new object[]{ // duplicated '3' in eighth column
            new []{
                new[]{1,3,2,5,7,9,4,6,8},
                new[]{4,9,8,2,6,1,3,7,5},
                new[]{7,5,6,3,8,4,2,1,9},
                ...
                new[]{2,1,4,9,3,5,6,8,7},
                new[]{3,6,5,8,1,7,9,2,4},
                new[]{8,7,9,6,4,2,1,3,5}}, false
        },
        new object[]{ // valid rows and cols, but invalid boxes
            new []{
                new[]{1,2,3,4,5,6,7,8,9},
        ...
        new object[]{ 
            new []{ // valid boxes and rows, repeats in cols
                new[]{1,2,3,4,5,6,7,8,9},
                new[]{4,5,6,7,8,9,1,2,3},
                new[]{7,8,9,1,2,3,4,5,6},
                new[]{1,2,3,4,5,6,7,8,9},
    ...
    [Theory]
    [MemberData(nameof(FixedBoardData))]
    public void FixedTests(int[][] board, bool expected)
    {
        int[][] clone = Clone(board);
        bool actual = SudokuValidator.Validate(board);
        Assert.Equal(actual, expected);
        
        for (int rowNo = 0; rowNo < 9; ++rowNo)
        {
            Assert.Equivalent(clone[rowNo], board[rowNo]);
        }
    }
}